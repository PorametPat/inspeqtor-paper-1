...
def duffling_oscillator_hamiltonian(
    qubit_info: shared.QubitInformation,
    signal: Callable,
...
def rotating_duffling_oscillator_hamiltonian(
    qubit_info: shared.QubitInformation, signal: Callable
) -> qml.pulse.parametrized_hamiltonian.ParametrizedHamiltonian:
...
def transmon_hamiltonian(
    qubit_info: shared.QubitInformation, waveform: Callable
) -> qml.pulse.parametrized_hamiltonian.ParametrizedHamiltonian:
...
def rotating_transmon_hamiltonian(qubit_info: shared.QubitInformation, signal: Callable):
...
def get_simulator(
    ...
    hamiltonian: Callable[
        [shared.QubitInformation, Callable],
        qml.pulse.parametrized_hamiltonian.ParametrizedHamiltonian,
